...
This repository presents an enhanced YOLOv4-based object detection framework for **multi-scale object detection**. The key contributions of this research include:

1. **Loss Function Modification**: Integration of distance-based metrics into the loss function:
   - **NWD (Normalized Wasserstein Distance)**.
   - **BCD (Bhattacharyya Distance)** *(proposed as the best-performing loss function)*.

2. **Semantic Contextual Augmentation**: Improvement in small-object detection by augmenting DOTA satellite images with **contextually accurate placements** of small objects. This emphasizes the semantic properties and addresses challenges in small-object detection.
...
### Detection Results
Figures show detection results in various object distribution scenarios:
...
## Results and Visualization
- **Performance Table**: Included above.
- **Visual Comparisons**: Detection results for IoU, NWD, and BCD are visualized in Figures 1, 2, and 3.
...
@article{your_article,
  title={Multi-Scale Object Detection Using BCD-Based YOLOv4},
